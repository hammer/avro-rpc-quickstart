...
Note: version 1.1.0 of Avro is generating an error after closing the server. There is a JIRA pending for this: https://issues.apache.org/jira/browse/AVRO-130.
